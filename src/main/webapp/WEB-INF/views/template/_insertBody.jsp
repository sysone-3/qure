<!-- /WEB-INF/views/template/_insertBody.jsp -->
            ...
            <div class="form-group">
                ...
                <template id="checkItemTemplate">
                    <div class="check-item" data-index="{INDEX}">
                        ...
                        <div class="input-wrapper">
                            <input type="text" class="check-input" name="items[{INDEX}].label"
                                   maxlength="33" placeholder="점검 내용을 입력해주세요" aria-label="점검 항목 내용"/>
